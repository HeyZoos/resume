...
Senior software engineer, 10+ years across fintech, real estate, government, and research. Deep Python/Pandas expertise, strong on-call track record, focused on safely building and refactoring high-volume Airflow ETL pipelines. Loves game development.
...
- Rewrote the investment team's security master off LUSID in Airflow + Pandas; performance-focused second pass now processes hundreds of thousands of securities per run in minutes
